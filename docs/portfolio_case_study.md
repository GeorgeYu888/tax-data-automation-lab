...
Finance and tax teams often receive transaction data from different operational systems. Before specialists can rely on the data, they need to know:
...
I built a Python and SQL workflow that ingests synthetic ERP-style transaction data, applies configurable tax classification rules, validates data quality, compares outputs against expected values, and produces an audit summary.

The project includes:

- a metadata-driven rules file in YAML
- synthetic finance transaction data
